...
- [System Architecture](architecture.md) - Technical system design and architecture
...
- [Environment Configuration](deployment/environment.md) - Environment setup and variables
...
2. Ensure examples match current API
